...
class TwigServiceProvider extends ViewServiceProvider
{
    ...
    public function registerTwigEngine()
    {
        ...
        $app['TwigView']->addExtension($app['config']->get('twigbridge::extension', 'twig'), 'twig', function () {
                print "<br>ADDED EXTENSION!";
                // Get any global variables
                $globals = $this->app['config']->get('twigbridge::globals', array());
                return new Engines\TwigEngine($this->app['twig'], $globals);
